...
export const Cars: FC = () => {
  ...
  useEffect(() => {
    ...
    axios.get<any, AxiosResponse<CarManufacturerType[]>>(`${process.env.REACT_APP_SERVER_NAME}/manufacturers`).then(response => {
      ...
      axios.get<any, AxiosResponse<CarCategoryType[]>>(`${process.env.REACT_APP_SERVER_NAME}/categories`).then(response => {
        ...
        axios.get<any, AxiosResponse<CarType[]>>(`${process.env.REACT_APP_SERVER_NAME}/cars`).then(response => {
