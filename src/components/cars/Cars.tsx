...
export const Cars: FC = () => {
  ...
  useEffect(() => {
    ...
    axios.get<any, AxiosResponse<CarManufacturerType[]>>(`https://carleacom.herokuapp.com/manufacturers`).then(response => {
      ...
      axios.get<any, AxiosResponse<CarCategoryType[]>>(`https://carleacom.herokuapp.com/categories`).then(response => {
        ...
        axios.get<any, AxiosResponse<CarType[]>>(`https://carleacom.herokuapp.com/cars`).then(response => {
